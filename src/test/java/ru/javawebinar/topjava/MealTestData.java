...
public class MealTestData {
    ...
    public static final Meal MEAL4 = new Meal(GLOBAL_ID + 6, of(2017, 3, 22, 10, 0, 0), "Завтрак",500);
    public static final Meal MEAL5 = new Meal(GLOBAL_ID + 7, of(2017, 3, 22, 13, 0, 0), "Обед",1000);
    public static final Meal MEAL6 = new Meal(GLOBAL_ID + 8, of(2017, 3, 22, 19, 0, 0), "Ужин",500);

    public static final Meal ADMIN_MEAL1 = new Meal(GLOBAL_ID + 3, of(2017, 3, 21, 10, 20, 0), "Завтрак админ",600);
    public static final Meal ADMIN_MEAL2 = new Meal(GLOBAL_ID + 4, of(2017, 3, 21, 13, 0, 0), "Обед админ",700);
    public static final Meal ADMIN_MEAL3 = new Meal(GLOBAL_ID + 5, of(2017, 3, 21 , 20, 0, 0), "Ужин админ",800);
